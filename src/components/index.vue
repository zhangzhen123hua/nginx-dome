    ...
    <el-row style="height:100%">
      <el-col :span="5" style="height:100%">
        <div class="lift_content ">
          <div class="left_title">推送服务APIDemo</div>
      ...
      <el-col :span="5" style="height:100%">
        <div class="mid_content">
          <div class="mid_content_top">SendSms</div>
          <el-divider></el-divider>
          ...
          <el-tabs type="border-card">
            <el-tab-pane label="Example Code">
              <div class="dome">
                ...
                <p>public static void main(String[] args){  jsonMap =new HashMap();//调用接口所需的参数</p>
                <p></p>
                <p>List info = new ArrayList();</p>
                <p>info.add("*****@dddd.com");</p>
                <p>jsonMap.put("emailes", info);//邮箱集合</p>
                <p>jsonMap.put("title","sssss");//邮件标题</p>
                <p>jsonMap.put("message","fsadads");//邮件内容</p>
                <p>try {</p>
                <p>String result =  LeanIotSendUtil.send("http://192.168.0.215:9001/interface/apidata ",</p>
                <p>"test", "123456",</p>
                <p>"sendMail.callback", "", jsonMap);</p>
